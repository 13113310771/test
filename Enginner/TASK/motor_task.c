...
void Motor_angle_init()
{
	// normal_angle
	{
		...
		Motor[joint_1].Angle.normal_angle = 1.57*6.33;
		Motor[joint_2].Angle.normal_angle = 1.57*6.33;
	...
	// bigisland_straight_angle
	{
		...
		Motor[joint_1].Angle.bigisland_straight_angle = 1.57*6.33;
		Motor[joint_2].Angle.bigisland_straight_angle = 1.57*6.33;
...
uint8_t Motor_offset_angle_init(void)
{
	...
	for(ID=12;ID<MOTOR_NUMBER;ID++)//堵转初始化
	{
